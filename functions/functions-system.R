...
#' 
#' The structure of \code(isClose) allows it to be used in traditional subsetting notation.
#' 
#' @param a number(s) ... numeric vector of length 1+
#' @param b number(s) ... numeric vector of length 1+
#' @param tol what is the tolerance level of "equalish" ... defaults to what is used in the function \code(all.equal)
#'
